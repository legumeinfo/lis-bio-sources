 ...
 *
 * Support for "matches=" has been added here for LIS synteny GFFs.
 *
 * @author Kim Rutherford
 */

public class SyntenyGFF3Record {
    ...
    /**
     * Create a SyntenyGFF3Record from a line of a GFF3 file
     * @param line the String to parse
     * @throws IOException if there is an error during parsing the line
     */
    public SyntenyGFF3Record(String line) throws IOException {
        parseLine(line);
    }
     ...
     * @throws IOException if there is an error during parsing the line
     */
    public SyntenyGFF3Record(String header, String line) throws IOException {
        parseLine(line);
        this.header = header;
    }
    ...
    /**
     * Create a new SyntenyGFF3Record
     ...
     */
    public SyntenyGFF3Record(String sequenceID, String source, String type, int start, int end,
    ...
    /**
     * Set the Id of this SyntenyGFF3Record.
     * @param id the new id
     */
    ...
    /**
     * Return the first value of the matches field from the attributes of this record.
     * @return the matches from the attributes of this record or null of there isn't a value
     */
    public String getMatches() {
        if (getAttributes().containsKey("matches")) {
            return getAttributes().get("matches").get(0);
        }
        return null;
    }
    ...
    public String toString() {
        return "<SyntenyGFF3Record: sequenceID: " + sequenceID + " source: " + source + " type: "
